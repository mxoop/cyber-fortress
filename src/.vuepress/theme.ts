...
const footerICP_HTML = `<span class="mark-blue">MIT Licensed</span> | Copyright © <span class="mark-orange">2024~Present</span><br>Powered By <span class="mark-red">Rain.K</span>`;
...
export default hopeTheme({
  ...
  plugins: {
    ...
    pwa: {
      favicon: '/cyber-fortress.jpg',
      cacheHTML: true,
      // cachePic: true,
      appendBase: true,
      apple: {
        icon: '/cyber-fortress.jpg',
        statusBarColor: 'black',
      },
      msTile: {
        image: '/cyber-fortress.jpg',
        color: '#000',
      },
      manifest: {
        icons: [
          {
            src: '/cyber-fortress.jpg',
            sizes: '512x512',
            purpose: 'maskable',
            type: 'image/jpg',
          },
